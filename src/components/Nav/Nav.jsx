...
const NavAccordionButton = styled.button`
  ...
  &.DownArrow::after {
    ...
    width: 20px;
    height: 20px;
    background-image: url('https://leechengwon.github.io/goobne/images/Nav/NavDownArrow.svg');
  ...
  &.UpArrow::after {
    ...
    width: 20px;
    height: 20px;
    background-image: url('https://leechengwon.github.io/goobne/images/Nav/NavUpArrow.svg');
    background-repeat: no-repeat;
  }
`;
